(() => {
  ...
  const helpTopics = [
    ...
    { id: 'meter', href: 'meter.html#meter', title: 'DPS Meter', keywords: 'dps meter damage live widget personal nearby players party alliance duties show bdm toggle', summary: 'Track live damage, DPS, damage share, and per-player ability breakdowns.' },
    ...
    { id: 'commands', href: 'troubleshooting.html#commands', title: 'Commands', keywords: 'commands slash bd betterdeaths bdw bdm bdr reset toggle dps meter overworld', summary: 'Open Better Deaths, toggle either widget, or reset the DPS meter in the overworld.' },
