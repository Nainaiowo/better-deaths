(() => {
  ...
  const helpTopics = [
    ...
    { id: 'meter', href: 'meter.html#meter', title: 'Damage Meter', keywords: 'damage meter dps live last pull party all combatants actions abilities pets limit break dots exact estimated attribution', summary: 'Read live or completed encounter damage, DPS, and ability breakdowns.' },
