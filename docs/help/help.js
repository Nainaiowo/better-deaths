(() => {
  ...
  const helpTopics = [
    ...
    { id: 'current-pull', href: 'widget.html#current-pull', title: 'Death Widget', keywords: 'death current pull widget concise normal popup recap button live last pull review move resize opacity icons preview scroll', summary: 'Keep a compact live death summary visible over gameplay.' },
    { id: 'meter', href: 'meter.html#meter', title: 'DPS Meter', keywords: 'dps meter damage live widget personal nearby players party alliance duties show', summary: 'Track live damage, DPS, damage share, and per-player ability breakdowns.' },
    { id: 'meter-columns', href: 'meter.html#meter-columns', title: 'DPS Meter columns and display', keywords: 'columns reorder drag drop add remove plus x reset name damage dps percent critical direct max hit deaths hits concise normal initials', summary: 'Choose your columns, reorder them, and switch between Normal and Concise display.' },
    { id: 'meter-encounters', href: 'meter.html#meter-encounters', title: 'DPS Meter encounters and preview', keywords: 'encounters history saved selected preview example live last current collapse expand local forty', summary: 'Inspect a saved encounter in the preview while the floating widget follows the live fight.' },
    { id: 'meter-resets', href: 'meter.html#meter-resets', title: 'DPS Meter resets and overworld combat', keywords: 'overworld reset bdr new encounter automatic three seconds combat end duty wipe restart', summary: 'Understand automatic encounter saving and overworld-only manual resets.' },
    { id: 'meter-values', href: 'meter.html#meter-values', title: 'Understanding DPS Meter values', keywords: 'personal dps duration damage timing rounding dots estimates rdps adps ndps unavailable comparison', summary: 'Understand encounter duration, personal DPS, rounding, and estimated damage.' },
    ...
    { id: 'commands', href: 'troubleshooting.html#commands', title: 'Commands', keywords: 'commands slash bd betterdeaths bdwidget betterdeathswidget bdr reset dps meter overworld', summary: 'Open Better Deaths, toggle the Death Widget, or reset the DPS meter in the overworld.' },
