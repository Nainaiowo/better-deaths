...
public sealed partial class Plugin : IDalamudPlugin
{
    ...
    private const long MaxDebugCaptureFileBytes = DebugCaptureFileRetention.MaximumBytes;
    ...
    private readonly Dictionary<(uint ActionId, uint ClassJobId, byte Level), DamageParsing.ActionPotencyProfile> actionPotencyProfileCache = new();
