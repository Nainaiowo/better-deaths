...
public sealed partial class RecapWindow : Window, IDisposable
{
    ...
    private const string CurrentChangelogVersion = "1.0.0.46";
    ...
    private static bool TryGetReplayActorKeyFromSourceKey(
        ...
        out string actorKey)
    {
        return ReplayEncounterModules.TryGetReplayActorKeyFromSourceKey(
            sourceKey,
            actors.Select(actor => actor.ActorKey),
            out actorKey);
    }
    ...
    {
        ImGui.TextUnformatted("v1.0.0.46");
        ImGui.TextDisabled("Stable update.");
        DrawWrappedBullet("Replaced /bdwidget and /betterdeathswidget with /bdw to toggle the Death Widget.");
        DrawWrappedBullet("Added /bdm to toggle the DPS Meter widget without stopping capture or resetting the encounter.");
        ...
        DrawWrappedBullet("Improved DoT snapshots for personal damage buffs and critical-hit rates.");

        ImGui.Separator();

        ImGui.TextUnformatted("v1.0.0.13");
        ImGui.TextDisabled("Testing update.");
        DrawHighlightedChangelogBullet("Improved DPS Meter accuracy and DoT simulation.");
        DrawWrappedBullet("Effective damage now excludes confirmed overkill and shield absorption, including damage dealt while a target remains at zero HP.");
        DrawWrappedBullet("Expanded raid-contributing DPS calculations.");

        ImGui.Separator();

        ImGui.TextUnformatted("v1.0.0.12");
        ImGui.TextDisabled("Testing update.");
        DrawHighlightedChangelogBullet("The DPS Meter now automatically includes nearby players, including alliances.");

        ImGui.Separator();

        ImGui.TextUnformatted("v1.0.0.11");
        ImGui.TextDisabled("Testing update.");
        DrawHighlightedChangelogBullet("Improved the Widgets page layout and column customization.");
        ...
        ImGui.TextUnformatted("v1.0.0.2");
        DrawHighlightedChangelogBullet("Small tweaks");
        ...
        DrawWrappedBullet("Analyze recorded Better Deaths pulls directly, or paste a complete FFLogs report or specific pull link.");
        DrawWrappedBullet("Added data-quality labels and a shortcut to open the selected mechanic in Replay.");
        DrawHighlightedChangelogBullet("Improved DMU P2 Forsaken replays using recorded mechanic targets instead of positional guesses.");
        DrawHighlightedChangelogBullet("Corrected Forsaken clone baits and All Things Ending cleaves to use the actual baited player, clone position, and settled direction.");
        DrawHighlightedChangelogBullet("Reduced false dungeon deaths and wipes caused by brief or missing player information.");
        DrawWrappedBullet("Added a Thank You message in the Updates tab for V1.0.");
        ...
        DrawWrappedBullet("Added data-quality labels and a shortcut to open the current mechanic in Replay.");
        DrawWrappedBullet("Improved analyzer legends and presentation, and kept Forsaken focused on its tower resolutions.");

        ImGui.Separator();

        ImGui.TextUnformatted("v0.1.0.291");
        ImGui.TextDisabled("Testing update.");
        DrawHighlightedChangelogBullet("Improved the WTF.DIG Analyzer's Black Hole snapshots, rotation guidance, and job labels.");

        ImGui.Separator();

        ImGui.TextUnformatted("v0.1.0.290");
        ImGui.TextDisabled("Testing update.");
        DrawHighlightedChangelogBullet("Fixed the Thank You window changing size while open.");

        ImGui.Separator();

        ImGui.TextUnformatted("v0.1.0.289");
        ImGui.TextDisabled("Testing update.");
        DrawHighlightedChangelogBullet("Updated the Analyzer and acknowledgements presentation.");

        ImGui.Separator();

        ImGui.TextUnformatted("v0.1.0.288");
        ImGui.TextDisabled("Testing update.");
        DrawHighlightedChangelogBullet("Updated the Analyzer presentation.");
