...
internal static class BetterDeathsThemeCatalog
{
    ...
    private static readonly BetterDeathsUiTheme BananaTheme = CreateTheme(
        ...
        "Banana",
        shell: new Vector4(0.96f, 0.90f, 0.82f, 0.92f),
        panel: new Vector4(1.0f, 0.96f, 0.90f, 0.96f),
        panelAlt: new Vector4(0.90f, 0.78f, 0.64f, 0.96f),
        border: new Vector4(0.64f, 0.46f, 0.30f, 0.95f),
        accent: new Vector4(0.80f, 0.34f, 0.04f, 1.0f),
        accentSoft: new Vector4(0.88f, 0.60f, 0.34f, 0.96f),
        highlight: new Vector4(0.58f, 0.24f, 0.00f, 1.0f),
        muted: new Vector4(0.42f, 0.30f, 0.24f, 1.0f),
        text: new Vector4(0.14f, 0.07f, 0.04f, 1.0f),
        danger: new Vector4(0.86f, 0.04f, 0.03f, 1.0f),
        damage: LightThemeDamageColor,
        heal: LightThemeHealColor,
        frame: new Vector4(0.84f, 0.68f, 0.54f, 0.98f),
        frameHovered: new Vector4(0.78f, 0.58f, 0.44f, 1.0f),
        popup: new Vector4(1.0f, 0.96f, 0.90f, 0.99f),
        navButton: new Vector4(0.84f, 0.70f, 0.56f, 0.98f),
        navButtonHovered: new Vector4(0.78f, 0.58f, 0.44f, 1.0f),
        navButtonSelected: new Vector4(0.78f, 0.48f, 0.26f, 0.98f),
        navButtonSelectedHovered: new Vector4(0.70f, 0.40f, 0.18f, 1.0f),
        frameBorderSize: 1.0f,
        divider: new Vector4(0.30f, 0.12f, 0.06f, 0.18f),
        barBackground: new Vector4(0.82f, 0.72f, 0.62f, 1.0f),
        barBorder: new Vector4(0.46f, 0.32f, 0.24f, 1.0f));
